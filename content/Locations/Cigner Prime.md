...
- **Entfernung zu Falano Port:** ca. eine Woche Reisezeit per Kennic-Turbine (Koloniefregatte). Die Route erfordert mehrere Hopping-Wegpunkte, da Cigner Prime deutlich weiter entfernt ist als [[Terra]].
...
- **Geräuschkulisse:** Ein Regenschauer auf einem _Ironbark Dome_ klingt wie ein maschinengewehrartiges Trommeln.
...
- **Optik:** Der Himmel färbt sich während eines Flares von Türkis in ein giftiges Neon-Pink oder Violett. Die _Reaktiven Schirm-Farne_ ziehen sich dann, wie zuvor beschrieben, sofort zurück.
...
| **Merkmal**             | **Cigner Prime**                        | **[[Terra]] (Vergleich)** |
| ----------------------- | --------------------------------------- | ------------------------- |
| **Windgeschwindigkeit** | Langsam, aber mit enormer Wuchtkraft    | Schnell und böig          |
| **Jahreszeiten**        | Kaum vorhanden (ewiger Herbst/Frühling) | Ausgeprägt                |
| **Himmelsfarbe**        | Hell-Türkis bis Gold                    | Blau                      |
| **Niederschlag**        | Schwere, schnelle Kaskaden              | Leichte Tropfen           |
...
|**Biom**|**Dominante Farbe**|**Hauptmerkmal**|
|---|---|---|
|**Obsidiana-Ebenen**|Schwarz / Violett|Cyanfarbene Biolumineszenz bei Nacht|
|**Eisenborken-Wald**|Tiefes Purpur|Massive, metallhaltige Kuppelbäume|
|**Aether-Archipel**|Türkis / Gold|Schwebende Inseln in dichten Wolken|
|**Das Große Auge**|Schwefelgelb|Extremer Luftdruck und Nebel|
...
Fliegen ist bei 1,4g extrem energieaufwendig. Aber die _dichtere Atmosphäre_ von Cigner Prime bietet mehr Auftrieb.
...
- **Materialien:** Die Außenhüllen bestehen aus dem dichten Holz der _Ironbark_-Bäume, verstärkt durch lokale Metalllegierungen. Die Fenster sind klein und bestehen aus dickem, strahlungsresistentem Quarzglas.

- **Lapis-Akzente:** In den zentralen Hallen findet man überall unverarbeitete Kristalle des _Lapis Somniorum_, die ein sanftes, beruhigendes violettes Licht abgeben und die Übelkeit durch die hohe Schwerkraft lindern sollen.
...
- **Lapis-Kerne:** In den Fundamenten jedes Wohnblocks befinden sich rotierende Kerne aus _Lapis Somniorum_. Diese erzeugen lokale "Dämpfungsfelder", die die Schwerkraft innerhalb der Stadt auf angenehmere **0,9 g bis 1,1 g** senken.
...
- **Kaskaden-Filter:** Große Fangbecken fangen den _Kaskaden-Regen_ auf. Da das Wasser voller Mineralien und Metalle ist, wird es durch riesige Filteranlagen (basierend auf der Biologie der _Sideris-Wurzel_) gereinigt.
